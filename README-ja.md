...
よく言われるように、あなたの思考はあなたが読んだものによって決まります。そして、私たちは長い間、雑音だらけのフィードを消費しすぎてきました！Foloはコンテンツを1つのタイムラインに整理し、重要な情報をノイズなくお届けします。リストを共有したり、コレクションを閲覧したり、気を散らすことなくブラウジングを楽しめます。

## 👋🏻 コミュニティに参加して始めましょう

ユーザーにとってもプロの開発者にとっても、Foloはオープンな情報の遊び場となります。Foloは現在開発中です、[issue](https://github.com/RSSNext/Folo/issues)（問題） が発生した場合はフィードバックをお待ちしております。

以下の方法でお気軽にお試しください:

| Operating System | Source                                                                                                                                                                                                                                                                                                                                                                                                                                |
| :--------------- | :------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| Web              | <a href="https://app.folo.is" target="_blank"><img src="https://github.com/user-attachments/assets/51ef7800-b683-4493-83e8-eb4752366997" alt="ブラウザー" height="55"/></a>                                                                                                                                                                                                                                                              |
...
コミュニティによって管理されている次の方法を使用してインストールすることもできます。

- Arch Linuxを使用している場合は、[timochan](https://github.com/ttimochan)と[grtsinry43](https://github.com/grtsinry43)によってメンテナンスされているパッケージ[folo-appimage](https://aur.archlinux.org/packages/folo-appimage)をインストールできます。
- Nix を使用している場合は、[iosmanthus](https://github.com/iosmanthus) によってメンテナンスされているパッケージ [follow](https://github.com/NixOS/nixpkgs/blob/master/pkgs/by-name/fo/follow/package.nix) をインストールできます。
- macOSで[Homebrew](https://brew.sh)を使用している場合は、[realSunyz](https://github.com/realSunyz)がメンテナンスしているcask [folo](https://formulae.brew.sh/cask/folo)をインストールできます。
- Windowsで[Scoop](https://scoop.sh)を使用している場合は、[cscnk52](https://github.com/cscnk52)が管理するマニフェスト[folo](https://github.com/cscnk52/cetacea/blob/master/bucket/folo.json)をインストールできます。

| [![Discord](https://img.shields.io/badge/dynamic/json?url=https%3A%2F%2Fdiscord.com%2Fapi%2Finvites%2Ffollowapp%3Fwith_counts%3Dtrue&query=approximate_member_count&color=5865F2&label=Discord&labelColor=black&logo=discord&logoColor=white&style=flat-square)](https://discord.gg/followapp) | Discord サーバーに参加して、開発者とつながり、機能をリクエストし、サポートを受けましょう。 |
| :-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | :----------------------------------------------------------------------------------------------------------------- |
| [![](https://img.shields.io/badge/any_text-Follow-blue?color=2CA5E0&label=_&logo=x&labelColor=black&style=flat-square)](https://x.com/intent/follow?screen_name=folo_is) | 製品の最新情報や特典アクティビティへの参加については、X/Twitter でフォローしてください。 |

> \[!IMPORTANT\]
>
> **スターを付けてください**、GitHub からのすべてのリリース通知を遅滞なく受け取ることができます

![画像](https://github.com/user-attachments/assets/a08f9437-b24c-4388-8f01-2826e09eeaf2)
...
<a href="https://next.ossinsight.io/widgets/official/compose-last-28-days-stats?repo_id=783512367" target="_blank" style="display: block" align="center">
  <picture>
    ...
    <img alt="RSSNext/Folo のパフォーマンス統計 - 過去 28 日間" src="https://next.ossinsight.io/widgets/official/compose-last-28-days-stats/thumbnail.png?repo_id=783512367&image_size=auto&color_scheme=light" width="655" height="auto">
  </picture>
</a>
...
幅広いフィードと厳選されたリストを購読できます。お気に入りを厳選して、あなたにとって最も重要なことを常に把握しましょう。

![](https://github.com/user-attachments/assets/11dc7d21-f5d8-4e41-9269-24fc352aa02b)

### 指先で操作できるAI

翻訳、要約などの AI を活用した機能により、よりスマートで効率的なブラウジングが実現します。

![](https://github.com/user-attachments/assets/37cf4f2f-4c5e-4775-86e8-2fa1a1b2ecf5)

### 動的コンテンツのサポート

コンテンツは単なるテキストではないことを私たちは知っています。記事から動画、画像から音声まで、Foloならあらゆるコンテンツを網羅できます。

![](https://github.com/user-attachments/assets/d1379fd6-8767-476e-b0dc-d61753715e26)

### 単なるアプリ以上のもの

これは単なるアプリではありません。Foloはコミュニティであり、オープン性とコミュニティ主導の体験という新しい時代を切り開きます。

![](https://github.com/user-attachments/assets/62004a04-eaea-4f5d-bfbf-4e68b6b90286)

## 🤝 貢献

オープンソース コミュニティに参加して一緒に構築することを歓迎します。詳細については、[Contributing Guide](./CONTRIBUTING.md)（貢献ガイド） を確認してください。

## 🔏 コード署名ポリシー

Folo for Windows は、[SignPath.io](https://about.signpath.io/) が提供する無料のコード署名と、[SignPath Foundation](https://signpath.org/) による証明書を使用します。

macOS および iOS 用の Folo は、[Apple Developer Program](https://developer.apple.com/programs/) によって署名および認証されています。

リリースされたすべてのファイルは、[GitHub artifact attestations](https://github.com/RSSNext/Folo/attestations)（GitHub アーティファクト認証）によって検証され、その出所と整合性が保証されます。

## 📝 ライセンス

Folo は、以下の特別な例外を加えた GNU General Public License バージョン 3 に基づいてライセンスされます。

`icons/mgc` ディレクトリ内のすべてのコンテンツは https://mgc.mingcute.com/ によって著作権が保護されており、再配布することはできません。

`lottie` ディレクトリ内のすべてのコンテンツは、[Lottie Simple License](https://lottiefiles.com/page/license) に基づいて配布されます。